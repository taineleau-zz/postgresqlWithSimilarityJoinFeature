...
DATA(insert OID = 4377 ( levenshtein_distance_v2 PGNSP PGUID 12 1 0 0 f f f t f i 3 0 16 "25 25 20" _null_ _null_ _null_ _null_ levenshtein_distance_v2 _null_ _null_ _null_ ));
DESCR("levenshtein_distance_v2");
